...
LAB_MAP = {
    ...
    ("CREA", "DFGE4"):  ("Creatinine", "eGFR (CKD-EPI)"),
    ("CREA", "DFGE5"):  ("Creatinine", "eGFR"),
    ...
    ("FSC", "MORA2"):   ("CBC", "Monocytes (ratio)"),
    ("FSC", "MORPW"):   ("CBC", "Monocytes (ratio PW)"),
    ...
    ("FSC", "GRN3"):    ("CBC", "Granulocytes (abs)"),
    ("FSC", "GRN4"):    ("CBC", "Granulocytes"),
    ...
    ("FSC", "ANOH1"):   ("CBC", "Aniso (high)"),
    ("FSC", "ANOR1"):   ("CBC", "Aniso (ratio)"),
    ...
    ("FSC", "SAER2"):   ("CBC", "RBC satel."),
    ("FSC", "SAPL2"):   ("CBC", "Platelet satel."),
    ("FSC", "SBLA2"):   ("CBC", "Blasts (satel.)"),
    ("FSC", "SCEL2"):   ("CBC", "Schistocytes"),
    ("FSC", "SHIS3"):   ("CBC", "Histogram flag"),
